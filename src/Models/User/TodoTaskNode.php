 ...
 * @property-read Collection|TodoTaskNode[] $children
 * @property-read Collection|TodoRotatingGroup[] $groups
 * @property-read Collection|TodoSubItem[] $subItems
 * @property-read TodoBalance|null $todoBalance
 * @property-read TodoRotatingGroup|null $rotatingGroup
 *
 * The concrete Todo implementation of the generic self-referential node tree.
 * All tree mechanics (parent/children, move, reorder) come from
 * {@see HasNodeTree}; the Todo-specific columns and side-relations
 * (groups/sub_items/calendars/balance) live here.
 */
class TodoTaskNode extends BaseModelAbstract implements HasNodeTreeContract, HasValidationRulesContract
{
    use HasFactory, HasNodeTree, HasValidationRules, SoftDeletes;
    ...
    /**
     * Nodes are scoped to (bounded by) their owning component.
     */
    public function nodeScopeColumn(): ?string
    {
        return 'user_page_component_id';
    }
