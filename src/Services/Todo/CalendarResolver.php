...
/**
 * Resolves whether a Todo node is scheduled on a given date, from its attached
 * calendars (add/subtract rules) with a legacy day-of-week `schedule` fallback.
 *
 * This is Todo-specific scheduling logic and deliberately lives in the Todo
 * layer, not the generic framework.
 */
class CalendarResolver
{
     ...
     *
     * @param  Collection<int, TodoCalendar>  $calendars
     */
