...
return [
    ...
    */
    ...
    \Polis\Validators\InvitationTokenIsValidValidator::KEY =>
        'The :attribute is invalid.',
    \Polis\Validators\Subscription\MembershipPlanRateIsActiveValidator::KEY =>
        'The membership plan rate must be active for you to purchase it.',
    \Polis\Validators\Subscription\PaymentMethodIsOwnedByEntityValidator::KEY =>
        'This payment method does not belong to this user.',
    \Polis\Validators\ArticleVersion\SelectedIterationBelongsToArticleValidator::KEY =>
        'The selected article iteration id does not seem to be from the related article.',
    \Polis\Validators\OwnedByValidator::KEY =>
