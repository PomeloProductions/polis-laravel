...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // -----------------------------------------------------------------
        // Todo / time-tracking module (2026_03_29 .. 2026_07_16)
        // -----------------------------------------------------------------
        Schema::create('todo_templates', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->unique(['user_id', 'name', 'level']);
        });
        ...
        // timer_sessions created 2026_05_30 (before time_entries alters it)
        ...
        // time_entries + todo_balance_id (2026_04_27) + session_elapsed_seconds
        // (2026_05_10) + timer_session_id (2026_05_30)
        ...
        // todo_balances: precision widened (2026_04_14)
        ...
        // todo_balance_logs: time_entry_id replaced by source morph (2026_04_09);
        // precision widened (2026_04_14)
        ...
        Schema::create('check_offs', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('user_id');
            $table->unsignedInteger('todo_balance_id');
        ...
        // todo_task_nodes: cascade_ratio (2026_04_13), last_date->30 (2026_04_14),
        // todo_rotating_group_id (2026_04_16), show_checkmark (2026_05_25),
        // precision widening (2026_06_22), count_this_group (2026_07_16),
        // tally_step default 0 (2026_05_10)
        Schema::create('todo_task_nodes', function (Blueprint $table) {
            ...
            $table->decimal('tally_step', 10, 4)->default(0);
            $table->json('schedule')->nullable();
        ...
        // todo_rotating_groups: parent_group_id dropped (2026_04_16), last_date->30
        // (2026_04_14), cascade_ratio (2026_04_15)
        ...
        // NOTE: todo_rotating_items was DROPPED (2026_04_16) — not created.
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('check_offs');
